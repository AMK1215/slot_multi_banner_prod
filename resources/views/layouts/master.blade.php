        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end" aria-labelledby="messagesDropdown">
                        <li>
                        ...
                        <li><a href="#" class="dropdown-item dropdown-footer">See All Messages</a></li>
                    </ul>
                </li>
