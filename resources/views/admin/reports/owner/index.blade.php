        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card " style="border-radius: 20px;">
                    ...
                    <form role="form" class="text-start" action="{{ route('admin.reports.owner') }}" method="GET">
                        <div class="row ml-5">
                            <div class="col-lg-3">
                                <div class="mb-3">
                            ...
                            <div class="col-log-3">
                                ...
                                <a href="{{ route('admin.reports.owner') }}" class="btn btn-warning" style="margin-top: 32px;">Refresh</a>
                            </div>
                        </div>
                    </form>
                    <div class="card-body">
